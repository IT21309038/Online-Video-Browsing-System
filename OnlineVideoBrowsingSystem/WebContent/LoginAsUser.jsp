...
<header class="head">
    ...
    <div class="container">
        ...
        <form name="myForm" method="post" action="login">
            ...
            <p>Forgot Password<a href="password.jsp" style="color: white; font-size: large;">Click Here</a></p>
            <p>Dont have an account no worries,Create one</p>
            <input type="button" value="Create Account" name="create" onclick="redirect()"><br>
        </form>
